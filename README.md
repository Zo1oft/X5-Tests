# Проект по автоматизации тестирования www.x5.ru
<a href="https://www.x5.ru/ru/"><img width="50%" title="Tinkoff" src="images/logo/x5group.png"></a>
...
- Проверка работы поиска на сайте (c PageObjects)
- Проверка работы станицы 'Покупателю' (c PageObjects)
- Проверка наличия Title на странице (работоспособности сайта)
- Проверка наличия ошибок в консоли

## :point_up_2: Сборка в Jenkins
### <a target="_blank" href="https://jenkins.autotests.cloud/job/Zoloft-X5-Tests/">Сборка в Jenkins</a>
<p align="center">
